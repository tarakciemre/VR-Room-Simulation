...
namespace Lightbug.Utilities
{
    ...
    public abstract class RigidbodyComponent : MonoBehaviour
    {
        ...
        //public abstract void SetRotation(Vector3 forward, Vector3 up);

        ///// <summary>
        ///// Rotates the character by doing yaw rotation (around its "up" axis).
        ///// </summary>
        ///// <param name="angle">The angle in degrees.</param>
        //public abstract void AddYaw(float angle);

        ///// <summary>
        ///// Rotates the character by doing yaw rotation (around its "up" axis).
        ///// </summary>
        ///// <param name="angle">The angle in degrees.</param>
        //public abstract void SetYaw(Vector3 forward);

        ///// <summary>
        ///// Rotates the character by doing yaw rotation (around its "up" axis).
        ///// </summary>
        ///// <param name="angle">The angle in degrees.</param>            
        //public void AddYaw(float angle, Vector3 pivot)
        //{
        ...
        ////protected override void RotateInternal(Quaternion deltaRotation)
        ////{
        ...
        ////    Position += preRotationCenter - postRotationCenter;
        ////}
        ...
        ///// </summary>
        ///// <param name="angle">The angle in degrees.</param>
        //public abstract void AddPitch(float angle);

        ///// <summary>
        ///// Rotates the character by doing yaw rotation (around its "up" axis).
        ///// </summary>
        ///// <param name="angle">The angle in degrees.</param>            
        //public void AddPitch(float angle, Vector3 pivot)
        //{
        ...
        ///// </summary>
        ///// <param name="angle">The angle in degrees.</param>
        //public abstract void AddRoll(float angle);

        ///// <summary>
        ///// Rotates the character by doing yaw rotation (around its "up" axis).
        ///// </summary>
        ///// <param name="angle">The angle in degrees.</param>            
        //public void AddRoll(float angle, Vector3 pivot)
        //{
        ...
        ///// <summary>
        ///// Rotates the character by performing 180 degrees of yaw rotation (around its vertical axis).
        ///// </summary>
        ///// <param name="angle">The angle in degrees.</param>
        //public void TurnAround() => AddYaw(180f);
